...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(AttributeErrorException.class)
    public final ResponseEntity<ErrorResponse> handleAttributeErrorException
            (AttributeErrorException ex, WebRequest request) {
        List<String> details = new ArrayList<>();
        details.add(ex.getLocalizedMessage());
